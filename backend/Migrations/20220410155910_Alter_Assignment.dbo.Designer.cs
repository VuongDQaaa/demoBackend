...
namespace backend.Migrations
{
    ...
    [Migration("20220410155910_Alter_Assignment.dbo")]
    partial class Alter_Assignmentdbo
    {
            ...
            modelBuilder.Entity("backend.Entities.Asset", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CategoryName = "Laptop",
                            InstalledDate = new DateTime(2022, 4, 10, 22, 59, 9, 551, DateTimeKind.Local).AddTicks(8102),
                        ...
                        new
                        {
                            ...
                            InstalledDate = new DateTime(2022, 4, 10, 22, 59, 9, 551, DateTimeKind.Local).AddTicks(8121),
                            Location = "sample location",
                            Specification = "this is sample data"
                        },
                        new
                        {
                            ...
                            InstalledDate = new DateTime(2022, 4, 10, 22, 59, 9, 551, DateTimeKind.Local).AddTicks(8123),
                            Location = "sample location",
                            Specification = "this is sample data"
                        });
                });
            ...
            modelBuilder.Entity("backend.Entities.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssetId = 2,
                            AssignedByUserId = 1,
                            AssignedDate = new DateTime(2022, 4, 10, 22, 59, 10, 122, DateTimeKind.Local).AddTicks(1387),
                            AssignedToUserId = 2,
                            AssignmentState = 0,
            ...
            modelBuilder.Entity("backend.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Gender = 0,
                            IsFirstLogin = true,
                            JoindedDate = new DateTime(2022, 4, 10, 22, 59, 9, 741, DateTimeKind.Local).AddTicks(354),
                            LastName = "Quy Vuong",
                            Location = 0,
                            PasswordHash = "$2a$11$YNh9RY2s6cMOhcueX9VCLuZ785yNUgeAuNO/vs/mfIShqVc0wqI.C",
                            Role = 0,
                            StaffCode = "AD1",
                            UserName = "Admin"
                        },
                        new
                        {
                            ...
                            Gender = 0,
                            IsFirstLogin = true,
                            JoindedDate = new DateTime(2022, 4, 10, 22, 59, 9, 930, DateTimeKind.Local).AddTicks(6486),
                            LastName = "Chi Huong",
                            Location = 0,
                            PasswordHash = "$2a$11$BjWub3Z0fDdiFcv38WF/juzaKtaEgjZzQ2gYY.UDVuvhr2N3NsAnu",
                            Role = 1,
                            StaffCode = "US2",
                            UserName = "Staff"
                        },
                        new
                        {
                            ...
                            Gender = 2,
                            IsFirstLogin = true,
                            JoindedDate = new DateTime(2022, 4, 10, 22, 59, 10, 122, DateTimeKind.Local).AddTicks(925),
                            LastName = "Chi Huong",
                            Location = 1,
                            PasswordHash = "$2a$11$oxmftfK2qziha.sqwo6og.CPW5L.v8ffp/ow.33EeKtIocMD6zuPy",
                            Role = 1,
                            StaffCode = "........",
                            UserName = "Huong"
                        });
