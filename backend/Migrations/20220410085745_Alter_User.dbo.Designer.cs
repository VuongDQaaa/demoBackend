...
namespace backend.Migrations
{
    ...
    [Migration("20220410085745_Alter_User.dbo")]
    partial class Alter_Userdbo
    {
            ...
            modelBuilder.Entity("backend.Entities.Asset", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CategoryName = "Laptop",
                            InstalledDate = new DateTime(2022, 4, 10, 15, 57, 44, 538, DateTimeKind.Local).AddTicks(3962),
                        ...
                        new
                        {
                            ...
                            InstalledDate = new DateTime(2022, 4, 10, 15, 57, 44, 538, DateTimeKind.Local).AddTicks(4034),
                            Location = "sample location",
                            Specification = "this is sample data"
                        },
                        new
                        {
                            ...
                            InstalledDate = new DateTime(2022, 4, 10, 15, 57, 44, 538, DateTimeKind.Local).AddTicks(4037),
                            Location = "sample location",
                            Specification = "this is sample data"
                        });
                });
            ...
            modelBuilder.Entity("backend.Entities.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssetId = 2,
                            AssignedByUserId = 1,
                            AssignedDate = new DateTime(2022, 4, 10, 15, 57, 45, 106, DateTimeKind.Local).AddTicks(1103),
                            AssignedToUserId = 2,
            ...
            modelBuilder.Entity("backend.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Gender = 0,
                            IsFirstLogin = true,
                            JoindedDate = new DateTime(2022, 4, 10, 15, 57, 44, 728, DateTimeKind.Local).AddTicks(3811),
                            LastName = "Quy Vuong",
                            Location = 0,
                            PasswordHash = "$2a$11$.YNjmYh6nR/mCNk.GJEYj.fqICYTZAtWAbh9DhynpydaMtyfp9dLm",
                            Role = 0,
                            StaffCode = "AD1",
                            UserName = "Admin"
                        },
                        new
                        {
                            ...
                            Gender = 0,
                            IsFirstLogin = true,
                            JoindedDate = new DateTime(2022, 4, 10, 15, 57, 44, 917, DateTimeKind.Local).AddTicks(2546),
                            LastName = "Chi Huong",
                            Location = 0,
                            PasswordHash = "$2a$11$7YZODrCF2bf0xps2eARDmOjkYy56dJSJDs8x3ti2SK.Pa1p8IWizS",
                            Role = 1,
                            StaffCode = "US2",
                            UserName = "Staff"
                        },
                        new
                        {
                            ...
                            Gender = 2,
                            IsFirstLogin = true,
                            JoindedDate = new DateTime(2022, 4, 10, 15, 57, 45, 106, DateTimeKind.Local).AddTicks(779),
                            LastName = "Chi Huong",
                            Location = 1,
                            PasswordHash = "$2a$11$JJ0M32yuuX20EUDvnBxGU.6h7I710mHRtledvjxBW7YLFAX3Aa8FS",
                            Role = 1,
                            StaffCode = "........",
                            UserName = "Huong"
                        });
