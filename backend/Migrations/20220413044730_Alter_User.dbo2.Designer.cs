...
namespace backend.Migrations
{
    ...
    [Migration("20220413044730_Alter_User.dbo2")]
    partial class Alter_Userdbo2
    {
            ...
            modelBuilder.Entity("backend.Entities.Asset", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CategoryName = "Laptop",
                            InstalledDate = new DateTime(2022, 4, 13, 11, 47, 28, 875, DateTimeKind.Local).AddTicks(5682),
                        ...
                        new
                        {
                            ...
                            InstalledDate = new DateTime(2022, 4, 13, 11, 47, 28, 875, DateTimeKind.Local).AddTicks(5709),
                            Location = "sample location",
                            Specification = "this is sample data"
                        },
                        new
                        {
                            ...
                            InstalledDate = new DateTime(2022, 4, 13, 11, 47, 28, 875, DateTimeKind.Local).AddTicks(5711),
                            Location = "sample location",
                            Specification = "this is sample data"
                        });
                });
            ...
            modelBuilder.Entity("backend.Entities.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssetId = 2,
                            AssignedByUserId = 1,
                            AssignedDate = new DateTime(2022, 4, 13, 11, 47, 29, 465, DateTimeKind.Local).AddTicks(2864),
                            AssignedToUserId = 2,
                            AssignmentState = 0,
            ...
            modelBuilder.Entity("backend.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Gender = 0,
                            IsFirstLogin = true,
                            JoindedDate = new DateTime(2022, 4, 13, 11, 47, 29, 71, DateTimeKind.Local).AddTicks(671),
                            LastName = "Quy Vuong",
                            Location = 0,
                            PasswordHash = "$2a$11$dSyLKvypV2m5IOLbdAjlH.17aRuS/xwo3U6U6Jb8khjkQZl.b3saW",
                            Role = 0,
                            StaffCode = "AD1",
                            UserName = "Admin",
                            UserState = 1
                        ...
                        new
                        {
                            ...
                            Gender = 0,
                            IsFirstLogin = true,
                            JoindedDate = new DateTime(2022, 4, 13, 11, 47, 29, 265, DateTimeKind.Local).AddTicks(7631),
                            LastName = "Chi Huong",
                            Location = 0,
                            PasswordHash = "$2a$11$DBqOwAKfk1XX2MOX4KOrLegy8Df352WnL8JQcHqw4Dy9RGFoOQGLS",
                            Role = 1,
                            StaffCode = "US2",
                            UserName = "Staff",
                            UserState = 1
                        ...
                        new
                        {
                            ...
                            Gender = 1,
                            IsFirstLogin = true,
                            JoindedDate = new DateTime(2022, 4, 13, 11, 47, 29, 465, DateTimeKind.Local).AddTicks(2363),
                            LastName = "Chi Huong",
                            Location = 1,
                            PasswordHash = "$2a$11$unDoa6l5.WNHAV.gxHw5JeNiISE4IQYqxg8Wdn0y0etTwk.uN4X12",
                            Role = 1,
                            StaffCode = "........",
                            UserName = "Huong",
                            UserState = 0
